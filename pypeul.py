...
class ServerConfig(object):
    ...
    @property
    def chanmodes(self):
        return namedtuple('chanmodes', ['user', 'string', 'numeric', 'normal'])._make(
            map(set, self.info['CHANMODES'].split(',')))
...
class IRC(object):
    def __init__(self, loggingEnabled=False, thread_callbacks=False):
